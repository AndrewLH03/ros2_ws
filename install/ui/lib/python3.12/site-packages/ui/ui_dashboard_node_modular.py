...
Enhanced modular dashboard with fullscreen scaling, complete functionality, and manual servo control visualization.
"""
...
class UIDashboardNode(Node):
    """
    Modular UI dashboard with fullscreen capabilities, all original functionality, and manual servo control support.
    """
    def __init__(self):
        ...
        self.status_data = {
            ...
            'finger_curl_ratios': None,  # For manual servo control
            'manual_servo_status': None  # Manual servo control status
        }
        ...
        self.get_logger().info('Modular UI dashboard started in fullscreen mode with manual servo control support')
    ...
    def _setup_subscribers(self):
        ...
        # Manual servo control subscriptions
    ...
    def finger_curl_callback(self, curl_msg):
        """Update finger curl ratios for manual servo control."""
        self.status_data['finger_curl_ratios'] = curl_msg.data
        
    def manual_servo_status_callback(self, status_msg):
        """Update manual servo control status."""
        self.status_data['manual_servo_status'] = status_msg.data
