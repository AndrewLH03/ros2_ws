...
class LifecycleManager(Node):
    ...
    def configure_node(self, node_name):
        ...
        return self._change_node_state(node_name, TransitionEvent.TRANSITION_CONFIGURE)
    
    def activate_node(self, node_name):
        """Activate a specific node."""
        return self._change_node_state(node_name, TransitionEvent.TRANSITION_ACTIVATE)
    
    def deactivate_node(self, node_name):
        """Deactivate a specific node."""
        return self._change_node_state(node_name, TransitionEvent.TRANSITION_DEACTIVATE)
    
    def cleanup_node(self, node_name):
        """Cleanup a specific node."""
        return self._change_node_state(node_name, TransitionEvent.TRANSITION_CLEANUP)
    ...
    def _get_transition_name(self, transition_id):
        ...
        transition_names = {
            TransitionEvent.TRANSITION_CONFIGURE: 'configure',
            TransitionEvent.TRANSITION_ACTIVATE: 'activate',
            TransitionEvent.TRANSITION_DEACTIVATE: 'deactivate',
            TransitionEvent.TRANSITION_CLEANUP: 'cleanup',
            TransitionEvent.TRANSITION_SHUTDOWN: 'shutdown'
        }
